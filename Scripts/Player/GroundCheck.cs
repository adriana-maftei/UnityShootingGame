...
public class GroundCheck : MonoBehaviour
{
    ...
    [HideInInspector]public float distanceThreshold = .15f;
    ...
    void OnDrawGizmosSelected() => Debug.DrawLine(RaycastOrigin, RaycastOrigin + Vector3.down * RaycastDistance, isGrounded ? Color.white : Color.red);
}
